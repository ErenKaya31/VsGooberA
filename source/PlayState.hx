...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeBar.createFilledBar(0xFF303030, 0xFFFFFFFF);
	...
	public function reloadTimeBarColors() {
		timeBar.createFilledBar(FlxColor.fromRGB(0xFF303030, dad.healthColorArray[0], dad.healthColorArray[1], dad.healthColorArray[2]));
